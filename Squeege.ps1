...
### If that doesn't work and you're running into certificate or blocked by policy, unblock the file, in powershell run the command 'Unblock-File .\Squeege.ps1'
