...
# GIT     : https://github.com/securityinfive/Squeegee-The-Windows-Cleaner
#########################################
...
$Banner = "#######################################################################
  _____  ____  _    _ ______ ______ _____ ______ ______ 
 / ____|/ __ \| |  | |  ____|  ____/ ____|  ____|  ____|
| (___ | |  | | |  | | |__  | |__ | |  __| |__  | |__   
 \___ \| |  | | |  | |  __| |  __|| | |_ |  __| |  __|  
 ____) | |__| | |__| | |____| |___| |__| | |____| |____ 
|_____/ \___\_\\____/|______|______\_____|______|______|                                                       
                   Windows Cleaner 1.0
#######################################################################
Author: Drew Koenig
Contact: securityinfive@binaryblogger.com
...
#    Loader
#=====================
Write-Host "Welcome To Squeegee."
Write-Host -ForegroundColor $AppInfoColor "[+]  SQUEEGEE is starting"
...
Write-Host -ForegroundColor $AppInfoColor "[+]  If running from Powershell console use the command 'powershell -STA -File Squeegee.ps1' or use the batch file."
...
Write-Host " "
Add-Content -Path $CurrentPath"\"$ReportName -Value "`r`n SQUEEGEE Scan Started on $CurrentDateTime."
#==================================
#   Get System Info
#==================================
...
Write-Host -ForegroundColor $AppInfoColor "[+] ***** The Squeegee Log Will Only Have The FOUND events. *****"
...
Write-Host " "
Write-Host -ForegroundColor $AppInfoColor "#############################################"
Write-Host -ForegroundColor $AppInfoColor "         --- Squeegee Scan Completed ---  "
Write-Host -ForegroundColor $AppInfoColor "#############################################"

Write-Host -ForegroundColor $AppInfoColor "#############################################"
Write-Host -ForegroundColor $AppInfoColor "          --- Opening Log File ---  "
Write-Host -ForegroundColor $AppInfoColor "#############################################"
notepad.exe $CurrentPath"\"$ReportName